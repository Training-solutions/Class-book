...
public interface CredentialsV1Api {
     ...
     * @param sort Sort criteria (can have multiple declarations - id, username, creationDate, changingDate, deleted) (optional, default to new ArrayList&lt;&gt;())
     ...
     *         or Internal server error (status code 500)
     */
    @ApiOperation(value = "List of credentials", nickname = "getCredentialList", notes = "", response = PageView.class, authorizations = {
    ...
    ResponseEntity<PageView<CredentialDto>> getCredentialList(Pageable pageable);
