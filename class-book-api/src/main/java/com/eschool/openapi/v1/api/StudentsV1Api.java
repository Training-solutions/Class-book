...
public interface StudentsV1Api {
     ...
     * @param sort Sort criteria (can have multiple declarations - id, firstName, lastName, creationDate, changingDate, deleted) (optional, default to new ArrayList&lt;&gt;())
     ...
     *         or Internal server error (status code 500)
     */
    @ApiOperation(value = "List of students", nickname = "getStudentList", notes = "", response = PageView.class, authorizations = {
    ...
    ResponseEntity<PageView<StudentDto>> getStudentList(Pageable pageable);
    ...
    ResponseEntity<CommonResponseDto> postStudent(
