...
@Validated
@Api(value = "ReportV1Api", description = "the ReportV1Api API")
public interface ReportV1Api {

    /**
     * GET /ui/reports : Get report by subject, teacher, group, student, startDate and endDate
     *
     ...
     */
    @ApiOperation(
        value = "Get report by subject, teacher, group, student, startDate and endDate",
        nickname = "getReport",
        notes = "",
        authorizations = {
